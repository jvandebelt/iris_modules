/**
 * \file components/gpp/phy/SampleSelector/SampleSelectorComponent.h
 * \version 1.0
 *
 * \section COPYRIGHT
 *
 ...
 * \section DESCRIPTION
 *
 * Sample Selector Component by Wei.
 */

#ifndef PHY_SAMPLESELECTORCOMPONENT_H_
#define PHY_SAMPLESELECTORCOMPONENT_H_
  ...
  : public PhyComponent
{
 public:
	 ...
	 */
  SampleSelectorComponent(std::string name);
 ...
 private:
   ...
   uint32_t sampleOffset_x,totalNumberOfSamples_x;
};
